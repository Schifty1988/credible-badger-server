...
const Legal = () => {
    return (
        <div className="Content">
            ...
            <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Credible Badger.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to Credible Badger, accessible from <a href="https://crediblebadger.com" rel="external nofollow noopener" target="_blank">https://crediblebadger.com</a></p>
            </li>
            <li>
            ...
            <h2>Contact Us</h2>
            <p>Michail Ostrowski - 712 H St NE Unit #649 - Washington, DC 20002</p>
            <p>Email: support@credibleanimals.com</p>
        </div>        
    </div>
    );
};
